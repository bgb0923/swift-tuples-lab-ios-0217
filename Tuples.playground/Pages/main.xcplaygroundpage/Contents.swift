 ...
 */
var person = (name: "Bill", age: 30)
/*: question2
 ### 2. Print out "<Name> is <Age> years old" using the tuple you created in Question 1.
 */
print("\(person.name), unfortunately has turned \(person.age) years old")
/*: question3
 ...
 */
let human = (name: "Joey", age: 32)
/*:
 ### 10. Can you change `human`'s age? Why or why not?
 */
// no its a constant you will not be able to change the age
